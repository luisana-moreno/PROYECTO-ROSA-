    ...
    <CModal visible={reactivateVisible} onClose={handleClose} backdrop="static" alignment="center">
      ...
      <CModalBody>
        <CAlert color="success">
          <strong>¡Confirmación!</strong> Esta acción reactivará al bovino.
          <br />
      ...
      <CModalFooter>
        ...
        <CButton
          color="success"
          onClick={handleReactivateCattle}
...
export default ReactivateCattleModal
