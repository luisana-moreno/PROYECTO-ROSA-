...
(
    ...
    ttr_fechaasi date,
    ttr_idtipasi integer DEFAULT 1, -- Valor por defecto para 'Presente'
...
ALTER TABLE IF EXISTS public.ttrasistenc
    ADD CONSTRAINT ttrasistenc_ttr_idtipasi_fkey FOREIGN KEY (ttr_idtipasi)
    REFERENCES public.tmatipasist (tma_idtipasi) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.ttrpaginsum
    ADD CONSTRAINT ttrpaginsum_ttr_idinsump_fkey FOREIGN KEY (ttr_idinsumo)
    REFERENCES public.ttrinsumoso (ttr_idinsumo) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.ttrprodlech
    ADD CONSTRAINT ttrprodlech_ttr_idlote_fkey FOREIGN KEY (ttr_idlote)
    REFERENCES public.tmalotes (tma_idlote) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE IF EXISTS public.ttrprodlech
    ADD CONSTRAINT ttrprodlech_ttr_idprolot_fkey FOREIGN KEY (ttr_idprolot)
    REFERENCES public.ttrprodLOTE (ttr_idprolot) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE IF EXISTS public.ttrprodLOTE
    ADD CONSTRAINT ttrprodLOTE_ttr_idlote_fkey FOREIGN KEY (ttr_idlote)
    REFERENCES public.tmalotes (tma_idlote) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.ttrregmedbovinos
    ADD CONSTRAINT ttrregmedbovinos_ttr_idbovino_fk_fkey FOREIGN KEY (ttr_idbovino_fk)
    REFERENCES public.ttrbovinoss (ttr_idbovino) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.ttrregmedbovinos
    ADD CONSTRAINT ttrregmedbovinos_ttr_idregmed_fk_fkey FOREIGN KEY (ttr_idregmed_fk)
    REFERENCES public.ttrregmedic (ttr_idregmed) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.ttrbovlotpotr
    ADD CONSTRAINT ttrbovlotpotr_ttr_idbovino_fkey FOREIGN KEY (ttr_idbovino)
    REFERENCES public.ttrbovinoss (ttr_idbovino) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE IF EXISTS public.ttrbovlotpotr
    ADD CONSTRAINT ttrbovlotpotr_ttr_idlote_fkey FOREIGN KEY (ttr_idlote)
    REFERENCES public.tmalotes (tma_idlote) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;

ALTER TABLE IF EXISTS public.ttrbovlotpotr
    ADD CONSTRAINT ttrbovlotpotr_ttr_idpotrer_fkey FOREIGN KEY (ttr_idpotrer)
    REFERENCES public.ttrpotreros (ttr_idpotrer) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
